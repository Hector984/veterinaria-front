...
const Aside = ({open}) => {
  return (
    <aside
      id="default-sidebar"
      className={`fixed border-r rtl:border-l rtl:border-r-0 border-border left-0 z-40 w-64 h-screen transition-transform ${open ? '' : '-translate-x-full'} sm:translate-x-0`}
      aria-label="Sidebar"
    >
